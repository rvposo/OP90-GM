...
double t;
	...
	{	
		...
		case PROGRAMAR_MTC: 
			...
			Diagnostico_TX[1][berco].cData [4] =0x00;
			Diagnostico_TX[1][berco].cData [3] = add_mtc_3; //0x2A;//<- endereço de inicio (4)    
			Diagnostico_TX[1][berco].cData [2] = add_mtc_2; //0x40;//<- endereço de inicio (3)    
			Diagnostico_TX[1][berco].cData [1] = add_mtc_1; //0x20;//<- endereço de inicio (2)
			Diagnostico_TX[1][berco].cData [0] =0x21;
		...
		case PROGRAMAR_MEC_SERVICE: 
			...
			Diagnostico_TX[1][berco].cData [7] =0x00;
			Diagnostico_TX[1][berco].cData [6] =0x00;// valor do byte a ser gravado(SERVIÇO = 0x00)
			Diagnostico_TX[1][berco].cData [5] =0x01;//<- Gravar 1 byte 
			Diagnostico_TX[1][berco].cData [4] =0x00;
			Diagnostico_TX[1][berco].cData [3] =0x49;//<- endereço de inicio (4) 
			Diagnostico_TX[1][berco].cData [2] =0x4D;//<- endereço de inicio (3) 
