...
typedef CAObjHandle MSXML2Obj_IXMLDOMNode;
typedef CAObjHandle MSXML2Obj_IXMLDOMParseErrorCollection;
typedef CAObjHandle MSXML2Obj_IXMLDOMParseError2;
...
extern const IID MSXML2_IID_IXMLDOMDocument3;
...
extern const IID MSXML2_IID_IXMLDOMParseError2;
extern const IID MSXML2_IID_IXMLDOMParseErrorCollection;
...
extern const IID MSXML2_IID_IMXXMLFilter;
...
HRESULT CVIFUNC MSXML2_IXMLDOMDocument2GetownerDocument (CAObjHandle objectHandle,
                                                         ERRORINFO *errorInfo,
                                                         MSXML2Obj_IXMLDOMDocument *XMLDOMDocument);
...
HRESULT CVIFUNC MSXML2_NewDOMDocument60IXMLDOMDocument3 (const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
                                                         CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenDOMDocument60IXMLDOMDocument3 (const char *fileName,
                                                          const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveDOMDocument60IXMLDOMDocument3 (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_NewFreeThreadedDOMDocument60IXMLDOMDocument3 (const char *server,
                                                                     int supportMultithreading,
                                                                     LCID locale,
                                                                     int reserved,
                                                                     CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenFreeThreadedDOMDocument60IXMLDOMDocument3 (const char *fileName,
                                                                      const char *server,
                                                                      int supportMultithreading,
                                                                      LCID locale,
                                                                      int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveFreeThreadedDOMDocument60IXMLDOMDocument3 (const char *server,
                                                                        int supportMultithreading,
                                                                        LCID locale,
                                                                        int reserved,
                                                                        CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetnodeName (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    char **name);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetnodeValue (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     VARIANT *value);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3SetnodeValue (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     VARIANT value);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetnodeType (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    MSXML2Type_DOMNodeType *type);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetparentNode (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      MSXML2Obj_IXMLDOMNode *parent);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetchildNodes (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      MSXML2Obj_IXMLDOMNodeList *childList);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetfirstChild (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      MSXML2Obj_IXMLDOMNode *firstChild);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetlastChild (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     MSXML2Obj_IXMLDOMNode *lastChild);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetpreviousSibling (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           MSXML2Obj_IXMLDOMNode *previousSibling);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetnextSibling (CAObjHandle objectHandle,
                                                       ERRORINFO *errorInfo,
                                                       MSXML2Obj_IXMLDOMNode *nextSibling);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getattributes (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      MSXML2Obj_IXMLDOMNamedNodeMap *attributeMap);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3insertBefore (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     MSXML2Obj_IXMLDOMNode newChild,
                                                     VARIANT refChild,
                                                     MSXML2Obj_IXMLDOMNode *outNewChild);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3replaceChild (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     MSXML2Obj_IXMLDOMNode newChild,
                                                     MSXML2Obj_IXMLDOMNode oldChild,
                                                     MSXML2Obj_IXMLDOMNode *outOldChild);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3removeChild (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    MSXML2Obj_IXMLDOMNode childNode,
                                                    MSXML2Obj_IXMLDOMNode *oldChild);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3appendChild (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    MSXML2Obj_IXMLDOMNode newChild,
                                                    MSXML2Obj_IXMLDOMNode *outNewChild);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3hasChildNodes (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      VBOOL *hasChild);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetownerDocument (CAObjHandle objectHandle,
                                                         ERRORINFO *errorInfo,
                                                         MSXML2Obj_IXMLDOMDocument *XMLDOMDocument);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3cloneNode (CAObjHandle objectHandle,
                                                  ERRORINFO *errorInfo,
                                                  VBOOL deep,
                                                  MSXML2Obj_IXMLDOMNode *cloneRoot);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetnodeTypeString (CAObjHandle objectHandle,
                                                          ERRORINFO *errorInfo,
                                                          char **nodeType);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Gettext (CAObjHandle objectHandle,
                                                ERRORINFO *errorInfo,
                                                char **text);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Settext (CAObjHandle objectHandle,
                                                ERRORINFO *errorInfo,
                                                const char *text);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getspecified (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     VBOOL *isSpecified);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getdefinition (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      MSXML2Obj_IXMLDOMNode *definitionNode);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetnodeTypedValue (CAObjHandle objectHandle,
                                                          ERRORINFO *errorInfo,
                                                          VARIANT *typedValue);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3SetnodeTypedValue (CAObjHandle objectHandle,
                                                          ERRORINFO *errorInfo,
                                                          VARIANT typedValue);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetdataType (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    VARIANT *dataTypeName);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3SetdataType (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    const char *dataTypeName);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getxml (CAObjHandle objectHandle,
                                               ERRORINFO *errorInfo,
                                               char **xmlString);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3transformNode (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      MSXML2Obj_IXMLDOMNode stylesheet,
                                                      char **xmlString);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3selectNodes (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    const char *queryString,
                                                    MSXML2Obj_IXMLDOMNodeList *resultList);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3selectSingleNode (CAObjHandle objectHandle,
                                                         ERRORINFO *errorInfo,
                                                         const char *queryString,
                                                         MSXML2Obj_IXMLDOMNode *resultNode);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getparsed (CAObjHandle objectHandle,
                                                  ERRORINFO *errorInfo,
                                                  VBOOL *isParsed);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetnamespaceURI (CAObjHandle objectHandle,
                                                        ERRORINFO *errorInfo,
                                                        char **namespaceURI);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getprefix (CAObjHandle objectHandle,
                                                  ERRORINFO *errorInfo,
                                                  char **prefixString);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetbaseName (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    char **nameString);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3transformNodeToObject (CAObjHandle objectHandle,
                                                              ERRORINFO *errorInfo,
                                                              MSXML2Obj_IXMLDOMNode stylesheet,
                                                              VARIANT outputObject);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getdoctype (CAObjHandle objectHandle,
                                                   ERRORINFO *errorInfo,
                                                   MSXML2Obj_IXMLDOMDocumentType *documentType);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getimplementation (CAObjHandle objectHandle,
                                                          ERRORINFO *errorInfo,
                                                          MSXML2Obj_IXMLDOMImplementation *impl);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetdocumentElement (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           MSXML2Obj_IXMLDOMElement *DOMElement);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3SetByRefdocumentElement (CAObjHandle objectHandle,
                                                                ERRORINFO *errorInfo,
                                                                MSXML2Obj_IXMLDOMElement DOMElement);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createElement (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      const char *tagName,
                                                      MSXML2Obj_IXMLDOMElement *element);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createDocumentFragment (CAObjHandle objectHandle,
                                                               ERRORINFO *errorInfo,
                                                               MSXML2Obj_IXMLDOMDocumentFragment *docFrag);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createTextNode (CAObjHandle objectHandle,
                                                       ERRORINFO *errorInfo,
                                                       const char *data,
                                                       MSXML2Obj_IXMLDOMText *text);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createComment (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      const char *data,
                                                      MSXML2Obj_IXMLDOMComment *comment);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createCDATASection (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           const char *data,
                                                           MSXML2Obj_IXMLDOMCDATASection *cdata);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createProcessingInstruction (CAObjHandle objectHandle,
                                                                    ERRORINFO *errorInfo,
                                                                    const char *target,
                                                                    const char *data,
                                                                    MSXML2Obj_IXMLDOMProcessingInstruction *pi);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createAttribute (CAObjHandle objectHandle,
                                                        ERRORINFO *errorInfo,
                                                        const char *name,
                                                        MSXML2Obj_IXMLDOMAttribute *attribute);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createEntityReference (CAObjHandle objectHandle,
                                                              ERRORINFO *errorInfo,
                                                              const char *name,
                                                              MSXML2Obj_IXMLDOMEntityReference *entityRef);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3getElementsByTagName (CAObjHandle objectHandle,
                                                             ERRORINFO *errorInfo,
                                                             const char *tagName,
                                                             MSXML2Obj_IXMLDOMNodeList *resultList);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3createNode (CAObjHandle objectHandle,
                                                   ERRORINFO *errorInfo,
                                                   VARIANT type,
                                                   const char *name,
                                                   const char *namespaceURI,
...
HRESULT CVIFUNC MSXML2_IXMLDOMDocument3nodeFromID (CAObjHandle objectHandle,
                                                   ERRORINFO *errorInfo,
                                                   const char *idString,
                                                   MSXML2Obj_IXMLDOMNode *node);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3load (CAObjHandle objectHandle,
                                             ERRORINFO *errorInfo,
                                             VARIANT xmlSource,
                                             VBOOL *isSuccessful);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetreadyState (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      long *value);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetparseError (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      MSXML2Obj_IXMLDOMParseError *errorObj);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Geturl (CAObjHandle objectHandle,
                                               ERRORINFO *errorInfo,
                                               char **urlString);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getasync (CAObjHandle objectHandle,
                                                 ERRORINFO *errorInfo,
                                                 VBOOL *isAsync);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Setasync (CAObjHandle objectHandle,
                                                 ERRORINFO *errorInfo,
                                                 VBOOL isAsync);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3abort (CAObjHandle objectHandle,
                                              ERRORINFO *errorInfo);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3loadXML (CAObjHandle objectHandle,
                                                ERRORINFO *errorInfo,
                                                const char *bstrXML,
                                                VBOOL *isSuccessful);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3save (CAObjHandle objectHandle,
                                             ERRORINFO *errorInfo,
                                             VARIANT destination);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetvalidateOnParse (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           VBOOL *isValidating);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3SetvalidateOnParse (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           VBOOL isValidating);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetresolveExternals (CAObjHandle objectHandle,
                                                            ERRORINFO *errorInfo,
                                                            VBOOL *isResolving);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3SetresolveExternals (CAObjHandle objectHandle,
                                                            ERRORINFO *errorInfo,
                                                            VBOOL isResolving);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3GetpreserveWhiteSpace (CAObjHandle objectHandle,
                                                              ERRORINFO *errorInfo,
                                                              VBOOL *isPreserving);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3SetpreserveWhiteSpace (CAObjHandle objectHandle,
                                                              ERRORINFO *errorInfo,
                                                              VBOOL isPreserving);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Setonreadystatechange (CAObjHandle objectHandle,
                                                              ERRORINFO *errorInfo,
                                                              VARIANT newValue);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Setondataavailable (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           VARIANT newValue);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Setontransformnode (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           VARIANT newValue);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getnamespaces (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      MSXML2Obj_IXMLDOMSchemaCollection *namespaceCollection);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3Getschemas (CAObjHandle objectHandle,
                                                   ERRORINFO *errorInfo,
                                                   VARIANT *otherCollection);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3SetByRefschemas (CAObjHandle objectHandle,
                                                        ERRORINFO *errorInfo,
                                                        VARIANT otherCollection);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3validate (CAObjHandle objectHandle,
                                                 ERRORINFO *errorInfo,
                                                 MSXML2Obj_IXMLDOMParseError *errorObj);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3setProperty (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    const char *name,
                                                    VARIANT value);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3getProperty (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    const char *name,
                                                    VARIANT *value);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3validateNode (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     MSXML2Obj_IXMLDOMNode node,
                                                     MSXML2Obj_IXMLDOMParseError *errorObj);

HRESULT CVIFUNC MSXML2_IXMLDOMDocument3importNode (CAObjHandle objectHandle,
                                                   ERRORINFO *errorInfo,
                                                   MSXML2Obj_IXMLDOMNode node,
                                                   VBOOL deep,
                                                   MSXML2Obj_IXMLDOMNode *clone);
...
HRESULT CVIFUNC MSXML2_NewXMLSchemaCache40IXMLDOMSchemaCollection2 (const char *server,
                                                                    int supportMultithreading,
                                                                    LCID locale,
                                                                    int reserved,
                                                                    CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenXMLSchemaCache40IXMLDOMSchemaCollection2 (const char *fileName,
                                                                     const char *server,
                                                                     int supportMultithreading,
                                                                     LCID locale,
                                                                     int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveXMLSchemaCache40IXMLDOMSchemaCollection2 (const char *server,
                                                                       int supportMultithreading,
                                                                       LCID locale,
                                                                       int reserved,
                                                                       CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_NewXMLSchemaCache60IXMLDOMSchemaCollection2 (const char *server,
                                                                    int supportMultithreading,
                                                                    LCID locale,
                                                                    int reserved,
                                                                    CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenXMLSchemaCache60IXMLDOMSchemaCollection2 (const char *fileName,
                                                                     const char *server,
                                                                     int supportMultithreading,
                                                                     LCID locale,
                                                                     int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveXMLSchemaCache60IXMLDOMSchemaCollection2 (const char *server,
                                                                       int supportMultithreading,
                                                                       LCID locale,
                                                                       int reserved,
                                                                       CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewXSLTemplate60IXSLTemplate (const char *server,
                                                     int supportMultithreading,
                                                     LCID locale, int reserved,
                                                     CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenXSLTemplate60IXSLTemplate (const char *fileName,
                                                      const char *server,
                                                      int supportMultithreading,
                                                      LCID locale, int reserved,
                                                      CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_ActiveXSLTemplate60IXSLTemplate (const char *server,
                                                        int supportMultithreading,
                                                        LCID locale,
                                                        int reserved,
                                                        CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewXMLHTTP60IXMLHTTPRequest (const char *server,
                                                    int supportMultithreading,
                                                    LCID locale, int reserved,
                                                    CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenXMLHTTP60IXMLHTTPRequest (const char *fileName,
                                                     const char *server,
                                                     int supportMultithreading,
                                                     LCID locale, int reserved,
                                                     CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_ActiveXMLHTTP60IXMLHTTPRequest (const char *server,
                                                       int supportMultithreading,
                                                       LCID locale, int reserved,
                                                       CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewServerXMLHTTPIServerXMLHTTPRequest (const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
                                                              CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenServerXMLHTTPIServerXMLHTTPRequest (const char *fileName,
                                                               const char *server,
                                                               int supportMultithreading,
                                                               LCID locale,
                                                               int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveServerXMLHTTPIServerXMLHTTPRequest (const char *server,
                                                                 int supportMultithreading,
                                                                 LCID locale,
                                                                 int reserved,
                                                                 CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_NewServerXMLHTTP30IServerXMLHTTPRequest (const char *server,
                                                                int supportMultithreading,
                                                                LCID locale,
                                                                int reserved,
                                                                CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenServerXMLHTTP30IServerXMLHTTPRequest (const char *fileName,
                                                                 const char *server,
                                                                 int supportMultithreading,
                                                                 LCID locale,
                                                                 int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveServerXMLHTTP30IServerXMLHTTPRequest (const char *server,
                                                                   int supportMultithreading,
                                                                   LCID locale,
                                                                   int reserved,
                                                                   CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewServerXMLHTTP60IServerXMLHTTPRequest2 (const char *server,
                                                                 int supportMultithreading,
                                                                 LCID locale,
                                                                 int reserved,
                                                                 CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenServerXMLHTTP60IServerXMLHTTPRequest2 (const char *fileName,
                                                                  const char *server,
                                                                  int supportMultithreading,
                                                                  LCID locale,
                                                                  int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveServerXMLHTTP60IServerXMLHTTPRequest2 (const char *server,
                                                                    int supportMultithreading,
                                                                    LCID locale,
                                                                    int reserved,
                                                                    CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewSAXXMLReader60IVBSAXXMLReader (const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
                                                         CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenSAXXMLReader60IVBSAXXMLReader (const char *fileName,
                                                          const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveSAXXMLReader60IVBSAXXMLReader (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewSAXXMLReader60ISAXXMLReader (const char *server,
                                                       int supportMultithreading,
                                                       LCID locale, int reserved,
                                                       CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenSAXXMLReader60ISAXXMLReader (const char *fileName,
                                                        const char *server,
                                                        int supportMultithreading,
                                                        LCID locale,
                                                        int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveSAXXMLReader60ISAXXMLReader (const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
                                                          CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60IMXWriter (const char *server,
                                                  int supportMultithreading,
                                                  LCID locale, int reserved,
                                                  CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60IMXWriter (const char *fileName,
                                                   const char *server,
                                                   int supportMultithreading,
                                                   LCID locale, int reserved,
                                                   CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60IMXWriter (const char *server,
                                                     int supportMultithreading,
                                                     LCID locale, int reserved,
                                                     CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60IMXWriter (const char *server,
                                                   int supportMultithreading,
                                                   LCID locale, int reserved,
                                                   CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60IMXWriter (const char *fileName,
                                                    const char *server,
                                                    int supportMultithreading,
                                                    LCID locale, int reserved,
                                                    CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60IMXWriter (const char *server,
                                                      int supportMultithreading,
                                                      LCID locale, int reserved,
                                                      CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60ISAXContentHandler (const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
                                                           CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60ISAXContentHandler (const char *fileName,
                                                            const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60ISAXContentHandler (const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
                                                              CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60ISAXContentHandler (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60ISAXContentHandler (const char *fileName,
                                                             const char *server,
                                                             int supportMultithreading,
                                                             LCID locale,
                                                             int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60ISAXContentHandler (const char *server,
                                                               int supportMultithreading,
                                                               LCID locale,
                                                               int reserved,
                                                               CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60ISAXErrorHandler (const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
                                                         CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60ISAXErrorHandler (const char *fileName,
                                                          const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60ISAXErrorHandler (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60ISAXErrorHandler (const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
                                                          CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60ISAXErrorHandler (const char *fileName,
                                                           const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60ISAXErrorHandler (const char *server,
                                                             int supportMultithreading,
                                                             LCID locale,
                                                             int reserved,
                                                             CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60ISAXDTDHandler (const char *server,
                                                       int supportMultithreading,
                                                       LCID locale, int reserved,
                                                       CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60ISAXDTDHandler (const char *fileName,
                                                        const char *server,
                                                        int supportMultithreading,
                                                        LCID locale,
                                                        int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60ISAXDTDHandler (const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
                                                          CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60ISAXDTDHandler (const char *server,
                                                        int supportMultithreading,
                                                        LCID locale,
                                                        int reserved,
                                                        CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60ISAXDTDHandler (const char *fileName,
                                                         const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60ISAXDTDHandler (const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
                                                           CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60ISAXLexicalHandler (const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
                                                           CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60ISAXLexicalHandler (const char *fileName,
                                                            const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60ISAXLexicalHandler (const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
                                                              CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60ISAXLexicalHandler (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60ISAXLexicalHandler (const char *fileName,
                                                             const char *server,
                                                             int supportMultithreading,
                                                             LCID locale,
                                                             int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60ISAXLexicalHandler (const char *server,
                                                               int supportMultithreading,
                                                               LCID locale,
                                                               int reserved,
                                                               CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60ISAXDeclHandler (const char *server,
                                                        int supportMultithreading,
                                                        LCID locale,
                                                        int reserved,
                                                        CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60ISAXDeclHandler (const char *fileName,
                                                         const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60ISAXDeclHandler (const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
                                                           CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60ISAXDeclHandler (const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
                                                         CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60ISAXDeclHandler (const char *fileName,
                                                          const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60ISAXDeclHandler (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60IVBSAXContentHandler (const char *server,
                                                             int supportMultithreading,
                                                             LCID locale,
                                                             int reserved,
                                                             CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60IVBSAXContentHandler (const char *fileName,
                                                              const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60IVBSAXContentHandler (const char *server,
                                                                int supportMultithreading,
                                                                LCID locale,
                                                                int reserved,
                                                                CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60IVBSAXContentHandler (const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
                                                              CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60IVBSAXContentHandler (const char *fileName,
                                                               const char *server,
                                                               int supportMultithreading,
                                                               LCID locale,
                                                               int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60IVBSAXContentHandler (const char *server,
                                                                 int supportMultithreading,
                                                                 LCID locale,
                                                                 int reserved,
                                                                 CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60IVBSAXDeclHandler (const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
                                                          CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60IVBSAXDeclHandler (const char *fileName,
                                                           const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60IVBSAXDeclHandler (const char *server,
                                                             int supportMultithreading,
                                                             LCID locale,
                                                             int reserved,
                                                             CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60IVBSAXDeclHandler (const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
                                                           CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60IVBSAXDeclHandler (const char *fileName,
                                                            const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60IVBSAXDeclHandler (const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
                                                              CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60IVBSAXDTDHandler (const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
                                                         CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60IVBSAXDTDHandler (const char *fileName,
                                                          const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60IVBSAXDTDHandler (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60IVBSAXDTDHandler (const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
                                                          CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60IVBSAXDTDHandler (const char *fileName,
                                                           const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60IVBSAXDTDHandler (const char *server,
                                                             int supportMultithreading,
                                                             LCID locale,
                                                             int reserved,
                                                             CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60IVBSAXErrorHandler (const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
                                                           CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60IVBSAXErrorHandler (const char *fileName,
                                                            const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60IVBSAXErrorHandler (const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
                                                              CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60IVBSAXErrorHandler (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60IVBSAXErrorHandler (const char *fileName,
                                                             const char *server,
                                                             int supportMultithreading,
                                                             LCID locale,
                                                             int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60IVBSAXErrorHandler (const char *server,
                                                               int supportMultithreading,
                                                               LCID locale,
                                                               int reserved,
                                                               CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXXMLWriter60IVBSAXLexicalHandler (const char *server,
                                                             int supportMultithreading,
                                                             LCID locale,
                                                             int reserved,
                                                             CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXXMLWriter60IVBSAXLexicalHandler (const char *fileName,
                                                              const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXXMLWriter60IVBSAXLexicalHandler (const char *server,
                                                                int supportMultithreading,
                                                                LCID locale,
                                                                int reserved,
                                                                CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXHTMLWriter60IVBSAXLexicalHandler (const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
                                                              CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXHTMLWriter60IVBSAXLexicalHandler (const char *fileName,
                                                               const char *server,
                                                               int supportMultithreading,
                                                               LCID locale,
                                                               int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXHTMLWriter60IVBSAXLexicalHandler (const char *server,
                                                                 int supportMultithreading,
                                                                 LCID locale,
                                                                 int reserved,
                                                                 CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewSAXAttributes60IMXAttributes (const char *server,
                                                        int supportMultithreading,
                                                        LCID locale,
                                                        int reserved,
                                                        CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenSAXAttributes60IMXAttributes (const char *fileName,
                                                         const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveSAXAttributes60IMXAttributes (const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
                                                           CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewSAXAttributes60IVBSAXAttributes (const char *server,
                                                           int supportMultithreading,
                                                           LCID locale,
                                                           int reserved,
                                                           CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenSAXAttributes60IVBSAXAttributes (const char *fileName,
                                                            const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveSAXAttributes60IVBSAXAttributes (const char *server,
                                                              int supportMultithreading,
                                                              LCID locale,
                                                              int reserved,
                                                              CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewSAXAttributes60ISAXAttributes (const char *server,
                                                         int supportMultithreading,
                                                         LCID locale,
                                                         int reserved,
                                                         CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenSAXAttributes60ISAXAttributes (const char *fileName,
                                                          const char *server,
                                                          int supportMultithreading,
                                                          LCID locale,
                                                          int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveSAXAttributes60ISAXAttributes (const char *server,
                                                            int supportMultithreading,
                                                            LCID locale,
                                                            int reserved,
                                                            CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXNamespaceManager60IVBMXNamespaceManager (const char *server,
                                                                     int supportMultithreading,
                                                                     LCID locale,
                                                                     int reserved,
                                                                     CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXNamespaceManager60IVBMXNamespaceManager (const char *fileName,
                                                                      const char *server,
                                                                      int supportMultithreading,
                                                                      LCID locale,
                                                                      int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXNamespaceManager60IVBMXNamespaceManager (const char *server,
                                                                        int supportMultithreading,
                                                                        LCID locale,
                                                                        int reserved,
                                                                        CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_NewMXNamespaceManager60IMXNamespaceManager (const char *server,
                                                                   int supportMultithreading,
                                                                   LCID locale,
                                                                   int reserved,
                                                                   CAObjHandle *objectHandle);

HRESULT CVIFUNC MSXML2_OpenMXNamespaceManager60IMXNamespaceManager (const char *fileName,
                                                                    const char *server,
                                                                    int supportMultithreading,
                                                                    LCID locale,
                                                                    int reserved,
...
HRESULT CVIFUNC MSXML2_ActiveMXNamespaceManager60IMXNamespaceManager (const char *server,
                                                                      int supportMultithreading,
                                                                      LCID locale,
                                                                      int reserved,
                                                                      CAObjHandle *objectHandle);
...
HRESULT CVIFUNC MSXML2_IXMLDOMParseError2GeterrorCode (CAObjHandle objectHandle,
                                                       ERRORINFO *errorInfo,
                                                       long *errorCode);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2Geturl (CAObjHandle objectHandle,
                                                 ERRORINFO *errorInfo,
                                                 char **urlString);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2Getreason (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    char **reasonString);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2GetsrcText (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     char **sourceString);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2Getline (CAObjHandle objectHandle,
                                                  ERRORINFO *errorInfo,
                                                  long *lineNumber);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2Getlinepos (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     long *linePosition);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2Getfilepos (CAObjHandle objectHandle,
                                                     ERRORINFO *errorInfo,
                                                     long *filePosition);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2GeterrorXPath (CAObjHandle objectHandle,
                                                        ERRORINFO *errorInfo,
                                                        char **xpathexpr);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2GetallErrors (CAObjHandle objectHandle,
                                                       ERRORINFO *errorInfo,
                                                       MSXML2Obj_IXMLDOMParseErrorCollection *allErrors);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2errorParameters (CAObjHandle objectHandle,
                                                          ERRORINFO *errorInfo,
                                                          long index,
                                                          char **param);

HRESULT CVIFUNC MSXML2_IXMLDOMParseError2GeterrorParametersCount (CAObjHandle objectHandle,
                                                                  ERRORINFO *errorInfo,
                                                                  long *count);

HRESULT CVIFUNC MSXML2_IXMLDOMParseErrorCollectionGetitem (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           long index,
                                                           MSXML2Obj_IXMLDOMParseError2 *error);

HRESULT CVIFUNC MSXML2_IXMLDOMParseErrorCollectionGetlength (CAObjHandle objectHandle,
                                                             ERRORINFO *errorInfo,
                                                             long *length);

HRESULT CVIFUNC MSXML2_IXMLDOMParseErrorCollectionGetnext (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           MSXML2Obj_IXMLDOMParseError2 *error);

HRESULT CVIFUNC MSXML2_IXMLDOMParseErrorCollectionreset (CAObjHandle objectHandle,
                                                         ERRORINFO *errorInfo);

HRESULT CVIFUNC MSXML2_IXMLDOMParseErrorCollectionGet_newEnum (CAObjHandle objectHandle,
                                                               ERRORINFO *errorInfo,
                                                               LPUNKNOWN *ppUnk);
...
HRESULT CVIFUNC MSXML2_IMXXMLFiltergetFeature (CAObjHandle objectHandle,
                                               ERRORINFO *errorInfo,
                                               const char *strName,
                                               VBOOL *fValue);

HRESULT CVIFUNC MSXML2_IMXXMLFilterputFeature (CAObjHandle objectHandle,
                                               ERRORINFO *errorInfo,
                                               const char *strName, VBOOL fValue);

HRESULT CVIFUNC MSXML2_IMXXMLFiltergetProperty (CAObjHandle objectHandle,
                                                ERRORINFO *errorInfo,
                                                const char *strName,
                                                VARIANT *varValue);

HRESULT CVIFUNC MSXML2_IMXXMLFilterputProperty (CAObjHandle objectHandle,
                                                ERRORINFO *errorInfo,
                                                const char *strName,
                                                VARIANT varValue);

HRESULT CVIFUNC MSXML2_IMXXMLFilterGetentityResolver (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      LPUNKNOWN *oResolver);

HRESULT CVIFUNC MSXML2_IMXXMLFilterSetByRefentityResolver (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           LPUNKNOWN oResolver);

HRESULT CVIFUNC MSXML2_IMXXMLFilterGetcontentHandler (CAObjHandle objectHandle,
                                                      ERRORINFO *errorInfo,
                                                      LPUNKNOWN *oHandler);

HRESULT CVIFUNC MSXML2_IMXXMLFilterSetByRefcontentHandler (CAObjHandle objectHandle,
                                                           ERRORINFO *errorInfo,
                                                           LPUNKNOWN oHandler);

HRESULT CVIFUNC MSXML2_IMXXMLFilterGetdtdHandler (CAObjHandle objectHandle,
                                                  ERRORINFO *errorInfo,
                                                  LPUNKNOWN *oHandler);

HRESULT CVIFUNC MSXML2_IMXXMLFilterSetByRefdtdHandler (CAObjHandle objectHandle,
                                                       ERRORINFO *errorInfo,
                                                       LPUNKNOWN oHandler);

HRESULT CVIFUNC MSXML2_IMXXMLFilterGeterrorHandler (CAObjHandle objectHandle,
                                                    ERRORINFO *errorInfo,
                                                    LPUNKNOWN *oHandler);

HRESULT CVIFUNC MSXML2_IMXXMLFilterSetByReferrorHandler (CAObjHandle objectHandle,
                                                         ERRORINFO *errorInfo,
                                                         LPUNKNOWN oHandler);
